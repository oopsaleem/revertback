...
import com.gelowb.config.DefaultProfileUtil;
...
public class RevertbackApp {

    private static final Logger log = LoggerFactory.getLogger(RevertbackApp.class);

    /**
     * Initializes RevertbackApp.
     * <p>
